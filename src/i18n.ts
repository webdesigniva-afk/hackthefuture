...
export const siteCopy = {
	en: {
		...
		intro: {
			...
			title: "What this is",
			intro: "Two days. Your team. A real problem. A jury that takes you seriously. A ceremony when the strongest teams get recognized in front of the city.",
			body: [
				"You and the other young people in the room pick one of four challenges facing Bulgaria right now. You spend two days working on it together. You build something real, a pitch, a prototype, a plan, a campaign, and you present it to a jury made up of people from business, government, and academia.",
			...
			statement: "If you've ever looked at something in your city, your school, or your country and thought \"this could be better,\" this is where you stop just thinking it.",
		},
		civicImage: {
	...
	bg: {
		...
		intro: {
			eyebrow: "ВЪВЕДЕНИЕ",
			title: "Какво представлява",
			intro: "Два дни. Твоят екип. Реален проблем. Жури, което ще приеме идеите ви сериозно. И церемония, на която най-силните отбори ще бъдат отличени пред цялата общност.",
			body: [
				"Заедно с останалите участници ще изберете едно от четирите предизвикателства, пред които България е изправена днес. В продължение на два дни ще работите заедно по него. Ще създадете нещо реално – идея, прототип, план, кампания или решение – и ще го представите пред жури от представители на бизнеса, публичния сектор и академичните среди.",
				"Не е нужно да си програмист. Не е нужно вече да имаш готова идея. Не е нужно да си отличник. Нужно е само да искаш да бъдеш част от това.",
			],
			statement: "Ако някога си погледнал към своя град, училище или държава и си си казал: „Това може да бъде по-добре“, тук е мястото, където спираш само да го мислиш и започваш да действаш.",
		},
		civicImage: {
		...
		footer: {
			statement: "Ти носиш енергията. Ние даваме предизвикателството. Заедно създаваме бъдещето.",
			founders: "Партньори",
